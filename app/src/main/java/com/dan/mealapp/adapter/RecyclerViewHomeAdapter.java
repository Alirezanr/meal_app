...
public class RecyclerViewHomeAdapter extends RecyclerView.Adapter<RecyclerViewHomeAdapter.RecyclerViewHolder>
{
    ...
    public RecyclerViewHomeAdapter(List<Categories.Category> categories)
    {
    ...
    {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_recycler_category,
                viewGroup, false);
